...
function setupSpreadsheetManagementBase() {
  ...
  var sheetDefinitions = [
    ...
    },
    {
      ...
      initialData: [
        ["CurrentStep", "第0工程 スプレッドシート管理基盤実装完了", "現在実行中の開発工程", "2026-09-01 05:40:00"],
        ["CurrentPlanDocument", "PLAN-02", "現在参照中の実装前計画書番号", "2026-09-01 05:40:00"],
        ["CurrentPlanName", "実装前計画書_修正版02", "現在参照中の実装前計画書名称", "2026-09-01 05:40:00"],
        ["CurrentInstructionDocument", "FIX-03", "現在参照中の指示書番号", "2026-09-01 05:40:00"],
        ["CurrentInstructionName", "第0工程開始前_管理基盤追加指示_03", "現在参照中の指示書名称", "2026-09-01 05:40:00"],
        ["SchemaVersion", "0.1.0", "現在のスプレッドシート構造バージョン", "2026-09-01 05:40:00"],
        ["ImplementationStatus", "STEP_0_IMPLEMENTED_WAITING_FOR_VERIFICATION", "実装ステータス", "2026-09-01 05:40:00"]
      ]
    },
    {
      ...
      initialData: [
        ...
        ["CP-STEP-0-COMPLETE", "第0工程管理基盤実装完了", "HEAD", "v0.1.0-checkpoint-0-complete", "0.1.0", "Pending", "2026-09-01 05:40:00"]
      ]
    },
    {
